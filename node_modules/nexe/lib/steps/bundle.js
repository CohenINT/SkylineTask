            ...
            switch (_f.label) {
                ...
                case 9:
                    if (input === util_1.STDIN_FLAG) {
                        maybeInput = resolve_dependencies_1.resolveFileNameSync(cwd, '.');
                    ...
                    return [4 /*yield*/, resolve_dependencies_1.default.apply(void 0, [input].concat(Object.keys(compiler.bundle.index).filter(function (x) { return x.endsWith('.js'); }), [{ cwd: cwd, expand: true, loadContent: false }]))];
                case 10:
